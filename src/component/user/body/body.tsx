...
import image from '../../../../public/static/240_F_111928864_4udzV1CbK1O8jA96wenKe4LEVqiebuzV-removebg-preview.png'
import image2 from '../../../../public/static/240_F_522654963_9emxRwsrpv1ZDpEiZ455gG1W96XuvRWv-removebg-preview.png'
import image3 from '../../../../public/static/dream_TradingCard__3_-removebg-preview.png'

const Body = () => {
  return (
    <div className='h-120vh w-full bg-white text-black'>

      <div className='flex flex-col md:flex-row justify-center items-center h-1/3  w-full'>
      ...
      <div className='flex flex-col-reverse md:flex-row justify-end items-center h-1/3 w-full'>
